...
"Is there difference in the (default) parsed data types?" This question means if the data type of each column is different when the dataset is imported through different methods.
